...
- Arranca Channel en Dolphin con el puerto 2 vacío; Ctrl+C no mata Dolphin. Accessibility de macOS para menús y teclado (`pynput`). `--probe-inputs` prueba Channel A y GBA2 A.
