...
def receive_jirachi(
    ...
    *,
    ...
    Caller must already have Channel booted with Port 2 empty and the original
    Ruby save restored. Does not parse SV and does not loop. Resets Channel so
    the PAL 50/60 Hz prompt is a known first step.
    """
...
def _channel_to_gba_prompt(pad: PadDriver) -> None:
